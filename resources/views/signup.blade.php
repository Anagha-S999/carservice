...
<img src="https://st.depositphotos.com/1008768/3377/i/950/depositphotos_33777219-stock-photo-register-here-sign.jpg" height="600px" alt="">
</div>
<div class="col col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
<form method="post">
{{csrf_field()}}
...
<tr>
    <td>Your Name</td>
    <td><input name="cname" type="text" class="form-control" required="required" ></td>
</tr>
<tr>
    <td>Your Email</td>
    <td><input name="cemail" type="email" name="email" id="email" class="form-control" required="required"></td>
</tr>
<tr>
    <td>Your Mobile No</td>
    <td><input name="cmobile" type="text" class="form-control" required="required"></td>
</tr>
<tr>
    <td>UserName</td>
    <td><input name="cusername" type="text" class="form-control" required="required"></td>
</tr>
<tr>
    <td>Password</td>
    <td><input name="cpassword" type="password" name="password" id="password" class="form-control" required="required"></td>
</tr>
<tr>
    <td>Confirm Password</td>
    <td><input name="confirm_password" type="password" name="password" id="password" class="form-control" required="required"></td>
</tr>
<tr>
    <td></td>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <div class="text-center p-3" style="background-color: light">
    © 2021 Copyright:
    <a class="text-light" href="https://mdbootstrap.com/">carservice.com</a>
  </div>
  <!-- Copyright -->
</footer>
    </div>
