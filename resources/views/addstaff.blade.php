...
<div class="container">
    <div class="row">
        <div class="col col-12 col-sm-3 col-md-3 col-lg-3 col-cl-3"></div>
        <div class="col col=12 col-sm-6 col-lg-6">
            ...
            <tr>
                <td>Name</td>
                <td><input name="staff_name" type="text" class="form-control"></td>
            </tr>
            <tr>
                <td>Email</td>
                <td><input name="staff_email" type="text" class="form-control"></td>
            </tr>
            <tr>
                <td>Mobile</td>
                <td><input name="staff_mobile" type="text" class="form-control"></td>
            </tr>
            <tr>
                <td>Designation</td>
                <td><input name="staff_des" type="text" class="form-control"></td>
            </tr>
            <tr><td>ServiceId</td>
                    <td><select name="ddlct" id="ddlct">
                    <option>---Select---</option>

                    <?php
                        if(isset($service))
                        {
                            foreach($service as $st)
                            {

                        
                    ?>
                    
                    <option value="<?php echo $st->id;?>"><?php echo $st->service_code;?></option>
            ...
            <tr>
                <td></td>
                <td><button class="btn btn-primary" name="btn" type="submit">Add</button></td>
            </tr>
            </table>          
            </form>
