...
<table class="table table-bordered" style="border:1px solid black" width="100%">
        ...
        <tr>
                ...
                <td><?php  if($st1->status==1){  echo "<h5 style='color:green'>Request Accepted</h5>";}else if($st1->status==2){ echo "<h5 style='color:red'>Request Rejected</h5>";}else { echo "<h5 style='color:black'>Request Pending</h5>";}?></td>
