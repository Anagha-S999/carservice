...
<div class="container">
    <div class="row">
        ...
        <div class="col col=12 col-sm-6 col-lg-6">
            <center><h2>View Staff</h2></center>
            <form  method="post">
            {{csrf_field()}}
...
<table class="table table-bordered" width="100%">
        ...
        <tr>
                ...
                ?>
                <td><?php echo $i;?></td>
                <td><?php echo $st1->s_name;?></td>  <td><?php echo $st1->s_mobile;?></td>
                <td><?php echo $st1->s_email;?></td>
                <td><a href="/viewstaff/<?php echo $st1->s_id;?>">Delete</a></td>
