...
<div class="container">
    <div class="row">
        ...
        <div class="col col=12 col-sm-6 col-lg-6">
            <center><h2>Add Services</h2></center>
            <form  method="post">
            ...
            <tr>
                <td>Service code</td>
                <td><input name="scode" type="text" class="form-control"></td>
            </tr>
            ...
            <tr>
                <td>Service Rate</td>
                <td><input name="srate" type="text" class="form-control"></td>
            </tr>
            <tr>
                <td></td>
                <td><button class="btn btn-primary" type="submit" name="btnsave">Add</button></td>
            </tr>
            </table>
            </form>
            </br></br>
<h1 align="center">View Service Details</h1>
<table border="1" width="600">
        ...
        <tr>
                ...
                <td><a href="/addservices/<?php echo $st1->id;?>">Delete</a></td>
